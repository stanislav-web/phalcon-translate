...
class TranslatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAssign()
    {
        ...
        $assign = $this->translate
            ...
            ->assign(self::TEST_PART)->setDefault('ru');
    ...
    public function testAssignNotFound() {
       ...
       $assign = $this->translate
            ->setTranslatePath(self::TEST_PATH)
            ->setLanguage('undefined_lang')
            ->assign('menu')->setDefault('en');

        $this->assertInternalType('object', $assign,
            "[-] assign() must return type as object"
        );
